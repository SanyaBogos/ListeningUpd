...
@Component({
  selector: 'appc-bukvitsa-page-x',
  templateUrl: './bukvitsa-page-x.component.html',
  styleUrls: ['./bukvitsa-page-x.component.scss', '../bukvitsy-table-x/bukvitsy-table-x.component.scss',
    '../../shared/styles/common.scss', '../../shared/styles/common-iniline.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class BukvitsaPageXComponent implements OnInit {
  ...
  private _findPosition(index: number) {
    ...
    // currently doesn't work, now ya has one symbol
    /*let yaCount = 0;
