...
@Component({
  selector: 'appc-bukvitsy-table',
  templateUrl: './bukvitsy-table.component.html',
  styleUrls: ['./bukvitsy-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class BukvitsyTableComponent implements OnInit {
