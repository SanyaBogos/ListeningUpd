...
export class SimpleNotificationsComponent extends BaseSubscriptionsComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this._subscriptions.add(
            this._service.getChangeEmitter().subscribe(this._handleChange.bind(this))
        );
    ...
    private _handleChange(item: NotificationEvent): void {
        switch (item.command) {
            case 'cleanAll':
                this.notifications = [];
                break;
