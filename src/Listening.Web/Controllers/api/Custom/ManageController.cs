...
using Listening.Core.ViewModels.Manage;
...
namespace Listening.Web.Controllers.api.Custom
{
    ...
    public class ManageController : BaseController
    {
        ...
        [HttpPost("getUsersByEmails")]
        [Authorize(Roles = "Admin,Super")]
        public async Task<IEnumerable<ApplicationUser>> GetUsersByEmails([FromBody]string[] emails)
        {
