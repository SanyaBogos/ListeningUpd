...
namespace Listening.Server.Controllers.api
{
    ...
    public class QuestionController : BaseController
    {
        ...
        [AllowAnonymous]
        [HttpPost("queried/")]
        public async Task<PagedDataViewModel<QuestionAndWordDescriptionDto>> GetQuestions([FromBody] QuestionQueryViewModel query)
        {
        ...
        [HttpGet("{id}")]
        public async Task<QuestionAndWordDescriptionDto> GetQuestion(long id)
        {
            throw new System.Exception("Not implemented");
