...
namespace Listening.Web.Migrations
{
    ...
    [Migration("20220205221432_IncreaseKnowledgeCoursesDescriptionSize")]
    partial class IncreaseKnowledgeCoursesDescriptionSize
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Crossword.Crossword", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("CrosswordDescriptionId")
                        .HasColumnType("bigint");

                    b.Property<long>("WordDescriptionId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("CrosswordDescriptionId");

                    b.HasIndex("WordDescriptionId");

                    b.ToTable("Crossword_Crosswords");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Crossword.CrosswordDescription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Crossword_CrosswordDescriptions");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Crossword.CrosswordResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int?>("TimeSpentMiliSeconds")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Crossword_CrosswordResults");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Crossword.QuestionDescription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Crossword_QuestionDescriptions");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Crossword.WordDescription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("QuestionDescriptionId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("QuestionDescriptionId");

                    b.ToTable("Crossword_WordDescriptions");
                });
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Access", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("Knowledge_Access");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("Knowledge_Authors");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("Knowledge_Books");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("Description")
                        .HasColumnType("character varying(5055)")
                        .HasMaxLength(5055);
                    ...
                    b.Property<string>("OriginalSite")
                        .HasColumnType("character varying(3000)")
                        .HasMaxLength(3000);
                    ...
                    b.ToTable("Knowledge_Courses");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.FileType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("Knowledge_FileTypes");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Folder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("Knowledge_Folders");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.TimeStamp", b =>
                {
                    ...
                    b.ToTable("Knowledge_TimeStamps");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Type", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Video", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("Description")
                        .HasColumnType("character varying(5500)")
                        .HasMaxLength(5500);
                    ...
                    b.ToTable("Knowledge_Videos");
                });

            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.VideoType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("Knowledge_VideoTypes");
                });
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Crossword.Crossword", b =>
                {
                    b.HasOne("Listening.Core.Entities.Specialized.Crossword.CrosswordDescription", "CrosswordDescription")
                        .WithMany("Crosswords")
                        .HasForeignKey("CrosswordDescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Listening.Core.Entities.Specialized.Crossword.WordDescription", "WordDescription")
                        .WithMany("Crosswords")
                        .HasForeignKey("WordDescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Crossword.CrosswordDescription", b =>
                {
                    b.HasOne("Listening.Core.Entities.Custom.ApplicationUser", "Assignee")
                        .WithMany()
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Crossword.CrosswordResult", b =>
                {
                    b.HasOne("Listening.Core.Entities.Specialized.Crossword.Crossword", "Crossword")
                        .WithMany("CrosswordResults")
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Crossword.WordDescription", b =>
                {
                    b.HasOne("Listening.Core.Entities.Specialized.Crossword.QuestionDescription", "QuestionDescription")
                        .WithMany("WordDescriptions")
                        .HasForeignKey("QuestionDescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Access", b =>
                {
                    b.HasOne("Listening.Core.Entities.Specialized.Knowledge.Course", "Course")
                        .WithMany("Accesses")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Listening.Core.Entities.Custom.ApplicationRole", "Role")
                        .WithMany("Accesses")
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Book", b =>
                {
                    ...
                    b.HasOne("Listening.Core.Entities.Specialized.Knowledge.FileType", "FileType")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Course", b =>
                {
                    b.HasOne("Listening.Core.Entities.Specialized.Knowledge.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Listening.Core.Entities.Specialized.Knowledge.Type", "Type")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.TimeStamp", b =>
                {
                    ...
                    b.HasOne("Listening.Core.Entities.Specialized.Knowledge.Video", "Video")
                        .WithMany("TimeStamps")
            ...
            modelBuilder.Entity("Listening.Core.Entities.Specialized.Knowledge.Video", b =>
                {
                    b.HasOne("Listening.Core.Entities.Specialized.Knowledge.Folder", "Folder")
                        .WithMany("Videos")
                        .HasForeignKey("FolderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Listening.Core.Entities.Specialized.Knowledge.VideoType", "VideoType")
                        .WithMany("Videos")
